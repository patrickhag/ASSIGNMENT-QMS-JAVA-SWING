...
public class quizExamStudent extends javax.swing.JFrame {
    ...
    public void question(){
        try
        {
            ...
            ResultSet rs=st.executeQuery("select id, name, opt1, opt2, opt4, answer from question where id = '"+questionId+"'");
            while(rs.next()){
    ...
    public void submit(){
        ...
        try{
            Connection con = ConnectionProvider.getCon();
            Statement st = con.createStatement();
            st.executeQuery("update student set marks = '"+marks+"' where rollNo = '"+rollNo+"'");
            String marks1 = String.valueOf(marks);
    ...
    public quizExamStudent(String rollNo) {
        ...
        try
        {
            Connection con = ConnectionProvider.getCon();
            Statement st=con.createStatement();
            ResultSet rs1=st.executeQuery("select rollNo, name, fatherName, motherName, gender, contactNo, email, address, marks from student where rollNo = '"+rollNo+"'");
            while(rs1.next()){
                jLabel13.setText(rs1.getString(2));
            }            
            ResultSet rs2=st.executeQuery("select id, name, opt1, opt2, opt4, answer from  where id = '"+questionId+"'");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1368, -1));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 310, 670));

        jLabel20.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jLabel20.setText("Question Demo?");
        getContentPane().add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 210, -1, -1));
        ...
        getContentPane().add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(412, 288, -1, -1));
        ...
        getContentPane().add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(412, 351, -1, -1));
        ...
        getContentPane().add(jRadioButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(412, 419, -1, -1));
        ...
        getContentPane().add(jRadioButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(412, 482, -1, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 640, -1, -1));
